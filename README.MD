...
This **MUST** be run at least once for helm automation to succeed installing postgres. Once it is set in the GSM the automation will continue to use it automatically.
