...
<p align="left">
  <strong>⚠️ Warning:</strong> This **MUST** be run at least once for helm automation to succeed installing postgres. Once it is set in the GSM the automation will continue to use it automatically.
Replace px-user-password and px-user with your desired credentials ensuring password is at least 12 characters in length and alphanumeric generated with at least one special character, capitalisation, numbers and digits. </p>
```
