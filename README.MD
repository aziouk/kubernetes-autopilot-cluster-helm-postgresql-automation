...
This resource consists of two components 1. Terraform Templates for **Google Kubernetes Engine (GKE) cluster** and 2. **Helm charts** for bootstrapping Terraform Built GKE Cluster in the same namespace.
