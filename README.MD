...
This resource consists of two components

*1. Terraform Templates for **Google Kubernetes Engine (GKE) cluster** 
*2. **Helm charts** Autoinstaller for bootstrapping Terraform Built GKE Cluster in the same namespace.
TODO: an all in one shellscript or terraform script that executes both component 1 and part 2.
