...
updating a single node won't do, you will need to assign it directly
...
# Working Automation for creating user, database, password in master cluster configuration
